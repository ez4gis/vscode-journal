...
export class VSCode {
    ...
    public getUserInputWithValidation(): Q.Promise<J.Model.Input> {
        ...
        try {
            ...
            let yesterday: DecoratedQuickPickItem = { label: this.ctrl.config.getInputLabelTranslation(2), description: this.ctrl.config.getInputDetailsTranslation(2), pickItem: JournalPageType.ENTRY, parsedInput: new J.Model.Input(-1), alwaysShow: true, path: "" }
            let tomorrow: DecoratedQuickPickItem = { label: this.ctrl.config.getInputLabelTranslation(3), description: this.ctrl.config.getInputDetailsTranslation(3), pickItem: JournalPageType.ENTRY, parsedInput: new J.Model.Input(1), alwaysShow: true, path: "" }
            let pickEntry: DecoratedQuickPickItem = { label: this.ctrl.config.getInputLabelTranslation(4), description: this.ctrl.config.getInputDetailsTranslation(4), pickItem: JournalPageType.ENTRY, alwaysShow: true, path: "" }
            let pickNote: DecoratedQuickPickItem = { label: this.ctrl.config.getInputLabelTranslation(5), description: this.ctrl.config.getInputDetailsTranslation(5), pickItem: JournalPageType.NOTE, alwaysShow: true, path: "" }
            ...
            input.items = [today, yesterday, tomorrow, pickEntry, pickNote];
